...
class multi_ue_scenario(gr.top_block):
    ...
    def __init__(self):
        ...
        self.ue5_pathloss_db = ue5_pathloss_db = 0
        self.ue4_prb = ue4_prb = 2
        self.ue4_pathloss_db = ue4_pathloss_db = 0
        self.ue3_prb = ue3_prb = 2
        self.ue3_pathloss_db = ue3_pathloss_db = 0
        self.ue2_prb = ue2_prb = 2
        self.ue2_pathloss_db = ue2_pathloss_db = 0
        self.ue1_prb = ue1_prb = 2
        self.ue1_pathloss_db = ue1_pathloss_db = 0
        ...
        self.digital_ofdm_tx_0_4_0_3 = digital.ofdm_tx(
            fft_len=fft_length,
            ...
            debug_log=False,
            scramble_bits=False)
        self.digital_ofdm_tx_0_4_0_2 = digital.ofdm_tx(
            fft_len=fft_length,
            cp_len=int(0.07*fft_length),
            packet_length_tag_key='',
            ...
            debug_log=False,
            scramble_bits=False)
        self.digital_ofdm_tx_0_4_0_1 = digital.ofdm_tx(
            fft_len=fft_length,
            cp_len=int(0.07*fft_length),
            packet_length_tag_key='',
            ...
            debug_log=False,
            scramble_bits=False)
        self.digital_ofdm_tx_0_4_0_0 = digital.ofdm_tx(
            fft_len=fft_length,
            cp_len=int(0.07*fft_length),
            packet_length_tag_key='',
        ...
        self.connect((self.digital_constellation_decoder_cb_0_1, 0), (self.digital_ofdm_tx_0_4_0_0, 0))
        self.connect((self.digital_constellation_decoder_cb_0_2, 0), (self.digital_ofdm_tx_0_4_0_1, 0))
        self.connect((self.digital_constellation_decoder_cb_0_3, 0), (self.digital_ofdm_tx_0_4_0_2, 0))
        self.connect((self.digital_constellation_decoder_cb_0_4, 0), (self.digital_ofdm_tx_0_4_0_3, 0))
        ...
        self.connect((self.digital_ofdm_tx_0_4_0_0, 0), (self.blocks_ue2_tx_pathloss, 0))
        self.connect((self.digital_ofdm_tx_0_4_0_1, 0), (self.blocks_ue3_tx_pathloss, 0))
        self.connect((self.digital_ofdm_tx_0_4_0_2, 0), (self.blocks_ue4_tx_pathloss, 0))
        self.connect((self.digital_ofdm_tx_0_4_0_3, 0), (self.blocks_ue5_tx_pathloss, 0))
